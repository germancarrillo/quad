...
int main(){
  ...
  //myfile.open("/dev/servoblaster"); myfile.seekp(0);
  //myfile.open("/tmp/servoblaster"); myfile.seekp(0);
...
void  Quad::Throttle(uint motorID,uint throttle){
  ...
  //myfile <<motorID<<"="<<throttle<<endl; myfile.seekp(0);
